...
for metric in metrics:
    ...
    plt.savefig("../graphs_Sanger/mse_Sanger_nmf_times.png", dpi=600)
    #plt.savefig("/home/tab43/Dropbox/Posters/Poster NIPS AABI 2016 v2/images/mse_Sanger_nmf_times.png", dpi=1200)