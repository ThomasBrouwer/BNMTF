...
for metric in metrics:
    ...
    plt.yticks(range(0,int(MSE_range[1])+1),fontsize=6)
    ...
    #plt.savefig("/home/tab43/Dropbox/Posters/Poster NIPS AABI 2016 v2/images/mse_Sanger_nmtf_times.png", dpi=1200)